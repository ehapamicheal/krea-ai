...
const Footer = () => {
    ...
    return (
        <footer className="bg-black/70 dark:bg-black/90 px-4 py-5 flex flex-col sm:flex-row gap-3 sm:justify-between items-center">
            <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-md bg-black dark:bg-white flex items-center justify-center">
                    <svg 
                ...
                <h3 className="text-lg text-white font-normal font-suisse">Krea AI</h3>
            </div> 

            <div className="flex items-center gap-x-3">
                <p className="text-base font-normal font-suisse text-white">curated by</p>
                <h2 className="text-2xl text-white"><span className="font-normal font-suisse">M</span> <span className="font-normal font-suisse">Mobbin</span></h2>
            </div> 
        </footer>
    )
}
